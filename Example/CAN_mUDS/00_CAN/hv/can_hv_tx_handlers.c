...
void data_collect_NAMI_EMS_03(struct can_message_s* tx_mess)
{
		...
		NAMI_EMS_03_frame.EMS_DesEMotorTorque = (p_7_EMS_DesEMotorTorqueToCAN - -819.1)/0.1;
...
void data_collect_NAMI_EMS_02(struct can_message_s* tx_mess)
{
		...
		NAMI_EMS_02_frame.EMS_DCMinVoltageHV = (p_7_EMS_DCMinVoltageHVToCAN - 0)/2;
		NAMI_EMS_02_frame.EMS_DCMinVoltageLV = (p_7_EMS_DCMinVoltageLVToCAN - 0)/0.1;
		NAMI_EMS_02_frame.EMS_DCDesVoltageHV = (p_7_EMS_DCDesVoltageHVToCAN - 0)/2;
		NAMI_EMS_02_frame.EMS_DCMaxCurrentLV = (p_7_EMS_DCMaxCurrentLVToCAN - 0)/2;
		NAMI_EMS_02_frame.EMS_DCDesVoltageLV = (p_7_EMS_DCDesVoltageLVToCAN - 0)/0.1;
		NAMI_EMS_02_frame.EMS_DCMaxCurrentHV = (p_7_EMS_DCMaxCurrentHVToCAN - 0)/0.2;
